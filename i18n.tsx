...
const translations = {
  en: {
    ...
    // Demo banner
    'demo.banner': 'Demo mode — add your Gemini API key in Settings for real generations.',
  ...
  ar: {
    ...
    'demo.banner': 'الوضع التجريبي — أضف مفتاح Gemini API في الإعدادات لتوليد حقيقي.',
