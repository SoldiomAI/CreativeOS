...
const translations = {
  en: {
    ...
    'library.noResults': 'No assets match your search.',
    'library.share': 'Share',
    ...
    'settings.pollinations': 'Pollinations (Free)',
    'settings.pollinations.active': 'Free provider active — no API key needed',
    'settings.pollinations.hint': 'Powered by pollinations.ai: free text and image generation with no signup — the free tier is rate-limited, so retry if it\'s busy. Voice, image editing and video need Gemini or OpenAI.',
  ...
  ar: {
    ...
    'library.delete': 'حذف',
    'library.close': 'إغلاق',
    'library.search': 'ابحث في الأصول...',
    'library.noResults': 'لا توجد أصول مطابقة لبحثك.',
    'library.share': 'مشاركة',
    'library.copied': 'تم النسخ!',
    'library.addTag': '+ وسم',
    'library.removeTag': 'إزالة الوسم',
    ...
    'settings.pollinations': 'Pollinations (مجاني)',
    'settings.pollinations.active': 'المزوّد المجاني فعّال — لا حاجة لمفتاح API',
    'settings.pollinations.hint': 'مدعوم من pollinations.ai: توليد نصوص وصور مجانًا دون تسجيل — الخدمة المجانية محدودة المعدل فأعد المحاولة إن كانت مشغولة. الأصوات وتعديل الصور والفيديو تتطلب Gemini أو OpenAI.',
