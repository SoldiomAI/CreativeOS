          ...
          {activeTab === AppTab.SETTINGS && (
            <div className="max-w-lg mx-auto h-full flex flex-col justify-center gap-4 p-4">
              ...
              <p className="text-gray-400 text-sm">
                Paste a free Hugging Face token to unlock ZeroGPU Spaces and Inference Providers. Get
                one at{' '}
                <a
              ...
              <p className="text-xs text-gray-500 font-mono">
                Stored only in this browser. Gemini / Veo still uses GEMINI_API_KEY from .env.local.
              </p>
